...
public class SolutionC {
	...
	public static void main(String[] args) {
		...
		emp.stream().filter(empOne -> empOne.getStatus().equals("active")).forEach(p -> System.out.println(p.getEmpName()));
		
		System.out.println( "\nInactive Employees are:");
		emp.stream().filter(empOne -> empOne.getStatus().equals("inactive")).forEach(p -> System.out.println(p.getEmpName()));
